...
print("\nMost probable bag sequence:", ', '.join([bags[obs] for obs in most_probably_state_sequence]))
print("Probability:", max([prob for prob, bag in dp[:,-1]]))